...
// 拖曳view的方向
typedef NS_ENUM(NSInteger, DSDragDirection) {
    DSDragDirectionAny,          /**< 任意方向 */
    DSDragDirectionHorizontal,   /**< 水平方向 */
    DSDragDirectionVertical,     /**< 垂直方向 */
};

@interface DSDragView : UIView<UIGestureRecognizerDelegate>
...
/**
 拖曳的方向，默认为any，任意方向
 */
@property (nonatomic,assign) DSDragDirection dragDirection;
...
/**
 点击的回调block
 */
@property (nonatomic,copy) void(^clickDragViewBlock)(DSDragView *dragView);

/**
 开始拖动的回调block
 */
@property (nonatomic,copy) void(^beginDragBlock)(DSDragView *dragView);
/**
 拖动中的回调block
 */
@property (nonatomic,copy) void(^duringDragBlock)(DSDragView *dragView);
/**
 结束拖动的回调block
 */
@property (nonatomic,copy) void(^endDragBlock)(DSDragView *dragView);
