...
@implementation DSDragView
/**
 DSDragView内部的一个控件imageView
 默认充满父视图
    ...
    switch (pan.state) {
        ...
        case UIGestureRecognizerStateChanged:
        {
            ...
            switch (self.dragDirection) {
                case DSDragDirectionAny:
                    dx = point.x - self.startPoint.x;
                    dy = point.y - self.startPoint.y;
                    break;
                case DSDragDirectionHorizontal:
                    dx = point.x - self.startPoint.x;
                    dy = 0;
                    break;
                case DSDragDirectionVertical:
                    dx = 0;
                    dy = point.y - self.startPoint.y;
                    break;
                default:
